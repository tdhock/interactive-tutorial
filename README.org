...
- Motivation for interactive graphics, 15 minutes :: The motivation for
     interactive graphics in exploratory data analysis, reporting
...
- Overview of high-level interactive plotting packages, 30 minutes ::
     An overview of packages that provide interactive graphics and
...
- Interactive graphics with shiny and plotly, 30 minutes :: asd
...
- Multi-panel graphics, facets in ggplot2, 15 minutes :: A multi-panel
     ...
     other). They are useful for showing [XXX Something missing here]
...
Besides the structure outlined above, we will generally be
highlighting what it means for a statistical graphic to be
"interactive," "animated," and "multi-layer", and discuss the
strengths and weaknesses of the existing R packages, to highlight
