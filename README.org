...
- Click on loss/BIC plot to select data and changepoint model, [[http://bl.ocks.org/tdhock/raw/43ac9c6be9188dcb02a7/][BIC]], [[https://github.com/tdhock/animint/blob/master/inst/examples/intreg.R][source]].
